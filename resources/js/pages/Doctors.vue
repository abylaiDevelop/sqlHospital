...
export default {
    ...
    methods: {
        initialize() {
            ...
            axios.get('/api/doctors').then(response=>this.allPermissions=response.data.data);
        },
        ...
        deleteItem(item) {
            ...
            axios.delete('/api/doctors/'+item.id).then(response=>console.log(response.data))
        ...
        save() {
            ...
            if (this.editedIndex > -1) {
                ...
                axios.post('/api/doctors/'+this.editedItem.patient_id+"?_method=PUT",this.editedItem).then(response=>console.log(response.data));
                this.initialize();
            } else {
                this.tableData.push(this.editedItem);
                axios.post('/api/doctors', this.editedItem).then(response=>console.log(response.data));
